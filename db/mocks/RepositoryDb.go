...
// GetRepositoryById provides a mock function with given fields: ctx, repositoryId
func (_m *RepositoryDb) GetRepositoryById(ctx context.Context, repositoryId int64) (*model.Repository, error) {
	ret := _m.Called(ctx, repositoryId)

	var r0 *model.Repository
	if rf, ok := ret.Get(0).(func(context.Context, int64) *model.Repository); ok {
